...
#         "NAME": config("Arvapalli"),
#         "USER": config("postgres"),
#         "PASSWORD": config("Greesh@3699"),
...
DATABASES = {
    'default': {
        ...
        'NAME': 'arvapalli',  # Replace with your database name
        'USER': 'root',  # Replace with your MySQL username
        'PASSWORD': '12345',  # Replace with your MySQL password
        'HOST': 'localhost',  # Keep it as 'localhost' if MySQL is running locally
...
# EMAIL_USE_TLS = True
# EMAIL_HOST_USER = config("arvapalligreesh@gmail.com")
# EMAIL_HOST_PASSWORD = config("Greesh@3699")
